...
TOPWEAR_FEATURES, TOPWEAR_PATHS = index_dataset("Topwear", "clothes_tryon_dataset/train/cloth", "clothes_tryon_dataset/train_captions_cleaned.csv", "topwear_database.pt", clip_model, clip_preprocess, device)
